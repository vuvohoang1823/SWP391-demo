 ...
 * @author hoang
 */
@WebServlet(name = "viewFormDetailHistoryServlet", urlPatterns = {"/viewFormDetailHistoryServlet"})
public class viewFormDetailHistoryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           appointment_detail_History = dao.getAppointmentDetailHistory(consultation_id);

            HttpSession session = request.getSession(true);
            session.setAttribute("Appointment_Detail_History",  appointment_detail_History);
            request.getRequestDispatcher("Staff_OrderList_Consult_HistoryDetail.jsp").forward(request, response);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
