 ...
 * @author ASUS
 */
@WebServlet(name = "BirdUpdatePageServlet", urlPatterns = {"/BirdUpdatePageServlet"})
public class BirdUpdatePageServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(BirdUpdatePageServlet.class.getName()).log(Level.SEVERE, null, ex);
