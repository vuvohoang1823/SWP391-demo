 ...
 * @author hoang
 */
@WebServlet(name = "ConsultationNotChooseCOntroller", urlPatterns = {"/ConsultationNotChooseCOntroller"})
public class ConsultationNotChooseCOntroller extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equals("approve")) {
            ...
            try {
                dao.updateAppointmentAndTrainerNotChooseTrainer(consultationId,TrainerID, RequestTrainerID);
