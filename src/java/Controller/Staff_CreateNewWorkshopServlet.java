 ...
 * @author LAPTOP
 */
@WebServlet(name = "Staff_CreateNewWorkshopServlet", urlPatterns = {"/Staff_CreateNewWorkshopServlet"})
@MultipartConfig(
        fileSizeThreshold = 1024 * 1024 * 2, // 2MB
        maxFileSize = 1024 * 1024 * 10, // 10MB
        maxRequestSize = 1024 * 1024 * 50 // 50MB
)
public class Staff_CreateNewWorkshopServlet extends HttpServlet {
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet Staff_CreateNewWorkshopServlet</title>");
//            out.println("</head>");
//            out.println("<body>");
...
//            workshop.setCategory(request.getParameter("category"));
            ...
            RequestDispatcher rd = request.getRequestDispatcher("Staff_Services_Workshop.jsp");
