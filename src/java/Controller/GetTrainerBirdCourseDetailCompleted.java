 ...
 * @author hoang
 */
@WebServlet(name = "GetTrainerBirdCourseDetailCompleted", urlPatterns = {"/GetTrainerBirdCourseDetailCompleted"})
public class GetTrainerBirdCourseDetailCompleted extends HttpServlet {
...
//        int bird_id = Integer.parseInt(request.getParameter("bird_id"));
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(GetTrainerBirdCourseDetailCompleted.class.getName()).log(Level.SEVERE, null, ex);
