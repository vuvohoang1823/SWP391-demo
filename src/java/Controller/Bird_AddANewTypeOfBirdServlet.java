 ...
 * @author ASUS
 */
@WebServlet(name = "Bird_AddANewTypeOfBirdServlet", urlPatterns = {"/Bird_AddANewTypeOfBirdServlet"})
public class Bird_AddANewTypeOfBirdServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Bird_AddANewTypeOfBirdServlet.class.getName()).log(Level.SEVERE, null, ex);
