...
public class BookingDTO {
    ...
    public BookingDTO(String customerName, String courseName, String typeBird, String birdID) {
        this.customerName = customerName;
        this.courseName = courseName;
        this.typeBird = typeBird;
        this.birdID = birdID;
    ...
    public BookingDTO(String customerName, String nameBird, String typeBird, String courseName, int coursePrice) {
        this.courseName = courseName;
        this.coursePrice = coursePrice;
        this.customerName = customerName;
        this.nameBird = nameBird;
