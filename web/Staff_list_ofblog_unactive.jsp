<%-- Document : Staff_list_ofblog Created on : Jul 4, 2023, 6:06:17 PM Author :
hoang --%> <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
    ...
    <head>
        ...
        <body>
            <div class="container-fluid">
                ...
                <div
                    id="containerPage"
                    class="col-md-8 col-lg-10 min-vh-100 p-0"
                    ...
                    <section class="form-body">
                            ...
                            <form class="form-inline my-2 my-lg-0">
                                <div
                                    ...
                                    <ul class="navbar-nav mr-auto">
                                        <li class="nav-item">
                                            <a class="nav-link" href="Staff_list_ofblog.jsp"
                                               >Active</a
                                            >
                                        </li>
                                        <li class="nav-item active">
                                            <a class="nav-link" href="Staff_list_ofblog_unactive.jsp"
                                               >Not active</a
                                            >
                                        </li>
                                    </ul>
                                ...
                                <div class="search-container">
                                    <div style="white-space: nowrap; padding-right: 2rem">
                                        Search by ID
                                    </div>
                        ...
                        <div
                            ...
                            style="font-size: 1.5rem; padding: 3rem 0"
                            >
                            Currently showing
                            <c:out value="${b.getLisofBlog('unavailable').size()}" /> blog(s)
                        </div>
                        <div class="blogs-container" style="flex-wrap: wrap">
                            <!-- start of card -->
                            <c:forEach var="card" items="${b.getLisofBlog('unavailable')}">
                                <div class="blog-container">
                                    ...
                                    <div class="desc-container">
                                        ...
                                        <div class="blog-description">${card.briefinfo}</div>
                                    </div>
                                    ...
                                    <div class="delete">
                                        <form
                                            ...
                                            <button
                                                ...
                                                data-bs-target="#confirmRestore-${card.blogid}"
                                                >
                                                Restore
                                            </button>
                                            <div
                                                class="modal fade"
                                                id="confirmRestore-${card.blogid}"
                                                tabindex="-1"
                                                aria-hidden="true"
                                                >
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h1 class="modal-title" style="font-size: 3rem">
                                                                Restore
                                                            </h1>
                                                            <button
                                                                type="button"
