                                                    ...
                                                    <form class="form-inline my-2 my-lg-0">
                                                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                                            <ul class="navbar-nav mr-auto">
                                                                ...
                                                                <li class="nav-item">
                                                                    <a class="nav-link active" href="staff_formBirdCourse_processing.jsp"><b>Processing</b></a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link" href="staff_formBirdCourse_completed.jsp"><b>Completed</b></a>
                                                                </li>
                                                                <li class="nav-item">
