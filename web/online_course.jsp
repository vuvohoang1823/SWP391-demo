        ...
        <div class="desc-container">
          <div style="height: 83%; overflow-y: hidden">
            ...
            <p>
              ...
              and fulfillment. Whether you aspire to train in corporate
              settings, educational institutions, or any other field, this
              comprehensive course will equip you with the essential skills and
              knowledge to excel as a trainer.
            </p>
          </div>
      ...
      <section class="onlineCourse-container">
        ...
        <div class="section-course">
          <div class="container">
            <div class="row">
              <c:forEach
                items="${i.allCourseOnlineTraining}"
                var="onlinetraining"
              >
                <div class="col-lg-4">
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div class="extra-price">
                        <div class="button-container">
                          <button class="btn btn-primary">
                            <a
                              href="MainController?action=view_online_course_detail&courseID=${onlinetraining.courseID}"
                      ...
                      <h5 class="card-title">${onlinetraining.title}</h5>
                      <div class="card-text">
                      ...
                      <div class="review">
                        ...
                        <b class="review-count col-lg-9"
                          >based on 100 reviews</b
                        >
                      </div>
                    </div>
                  </div>
