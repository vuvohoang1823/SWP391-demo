...
<html>
    <head>
        ...
        <style>
            ...
            .forgotPass-container .title{
                font-size: 3rem;
                font-weight: 800;
                margin-bottom: 1rem;
            }
            .forgotPass-container .sub-title{
                font-size: 2rem;
                font-weight: 800;
                margin-bottom: 3rem;
            }
            .forgotPass-container .recover-step{
                font-size: 1.5rem;
                font-weight: 400;
                line-height: 140%;
                margin-bottom: 3rem;
            ...
            <div class="row login-box">
                ...
                <div class="col-lg-6 auth-side">
                    ...
                    <div class="forgotPass-container">
                        ...
                        <div class="sub-title">Recover your password in 3 easy steps</div>
                        <p class="recover-step">
                            <span>1.</span> Enter email address below<br />
                            <span>2.</span> Our system will send you an OTP to your email<br />
                            <span>3.</span> Enter OTP on the next page
                        </p>
                        <div class="forgotPass-box" >
                            <p class="place-holder">Enter your email address.
                            </p>
                            <form action="forgotPassword" method="POST" style="position: relative">
                                <input type="email" placeholder="Emai address" name="email" required>
                                <div class="btn-container">
                                    <a href="signin.jsp">
                                        <button type="button">Cancel</button>
                                    </a>
                                    <button type="submit" name="action" value="Send OTP">Send OTP</button>
                                </div>
