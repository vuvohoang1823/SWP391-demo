...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/Certificate_reset.css">
        ...
        <div class="container-fluid">
            ...
            <div class="certif-container">
                ...
                <div class="certif-content">
                    ...
                    <p class="user-fullname">${customer.fullName}</p>
                    <div class="content-box">
                        <p>Has completed the course of <span class="course-name" style="font-weight: 800;">
                                ${course.title}
                            </span>.
                            The course covered
                            advanced techniques and methods for
                            training birds, including behavior shaping, positive reinforcement, and enrichment strategies.
                            By
                            completing this course, John has demonstrated a deep understanding of bird training principles
                            and
                            is equipped with the necessary skills to train birds effectively.</p>
                        <div class="signature">
                            <div class="sign1">
                                <p>TIFFANY MCPHERSON</p>
