            ...
            <section class="section-contactUs">
                ...
                <div class="right">
                    <div class="form-container">
                        ...
                        <form action="formappointment" method="POST" id="myForm">
                            <div class="content">
                                <div class="row">
                            ...
                            <div class="row" style="height: 15rem">
                                <textarea name="note" rows="4" cols="40" placeholder="Request message"></textarea>
                            </div>
                            <div class="radio-container">
                                <div class="radio">
                                    <input type="radio" name="type" value="Online" style="width: 2rem; margin-right: 2rem" required>
                                    <p>
                                        Online
                                    </p>
                                </div>
                                <div class="radio">
                                    <input type="radio" name="type"  value="Offline" style="width: 2rem; margin-right: 2rem" required>
                                    <p>
                                        Offline
                                    </p>
                                </div>
                                ...
                                <div
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button  name="action" type="button"  value="Submit Form" class="btn btn-secondary" data-bs-dismiss="modal" onclick="submitOnClose(event)">Close</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
