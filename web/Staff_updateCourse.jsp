                            ...
                            <form action="UpdateCourse" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-customerDetails">
                                    ...
                                    <div class="forms-footer">
                                        <button type="submit" name="action" value="cancel" class="btn approve" style="width: 30rem; margin: 1rem">Cancel</button>
                                        <button type="submit" name="action" value="update" class="btn approve" style="width: 30rem; margin: 1rem">Update this course</button>
                                        <button type="submit" name="action" value="delete" class="btn approve" style="width: 30rem; margin: 1rem">Delete this course</button>
                                    </div>
                                </div>
                            </form>
                        </div>
