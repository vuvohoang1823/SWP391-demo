<%--
    Document   : signUp
    Created on : Jun 30, 2023, 10:01:55 PM
    Author     : thang
--%>
    ...
    <body>
        <div class="container-fluid login-background">
            ...
            <div class="row login-box">
                <div class="col-lg-6 logo-side p-0">
                ...
                <div class="col-lg-6 auth-side">
                    ...
                    <form class="form-control" action="MainController" method="post">
                        ...
                        <button class="cna-btn"  name="action" value="register">Create new account</button>
                        <div class="p-3 text-center" style="width: 37rem;">Already have an account? <a href="signin.jsp">Sign In here</a>.</div>
                    </form>
                </div>
            </div>
        </div>
