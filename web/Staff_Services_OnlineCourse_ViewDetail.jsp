                    ...
                    <div class="container-fluid" style="padding: 0 2.5%">
                        <div class="forms-container">
                            ...
                            <!--<form action="UpdateServlet" method="POST" enctype="multipart/form-data">-->
                                <input type="hidden" value="${online.courseID}" name="courseID"/>
...
<!--                                        <div class="row">
                                ...
                                <div class="forms-footer">
                                    <div>
                                        <a href="Staff_Services_OnlineCourse_Update.jsp">
                                        <button type="submit" name="action" value="update" class="btn create">Edit</button>
                                        </a>
                                    </div>
                                    <div>
                                        <a href="Staff_Services_OnlineCourse.jsp">
