                ...
                <form action="SetTrainerToBooking" method="post">
                    ...
                    <div class="form-formDetails">
                        ...
                        <div class="forms-footer">
                            ...
                            <div> <button type="submit" name="action" value="approve" class="btn approve" style="margin-top: 4rem;">Update</button>
                            </div>

                            <div>
                                <button type="submit"  name="action" value="deny"class="btn btn-danger" style="border-radius: 10px;margin-top: 4rem;">Delete</button>
                            </div>
                        </div>
                </form>
            </div>
