<%-- Document : online_course_detail Created on : Jun 14, 2023, 8:40:43 PM Author : vuvoh --%>
        ...
        <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
            ...
            <body>
                <%@ include file="header.jsp" %>
                    ...
                    <section class="section-body" style="background-color: #DDE6F1">
                        <div class="col-xl-5">
                            <div class="body-content-left">
                                <img src="data:images/jpg;base64,${detail.image}" class="card-img-top"
                                    alt="Product 1" />
                                ...
                                <div class="week-module">
                                    ...
                                    <div class="col-xl-6">
                                        <div style="color: #617a55">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                                fill="currentColor" class="bi bi-grid-3x2-gap-fill" viewBox="0 0 16 16">
                                                <path
                        ...
                        <div class="col-xl-7">
                            <div class="first-content">
                                ...
                                <p>
                                    <img src="img/349252734_479596974359728_5596993599118262797_n.png"
                                        alt="first content tick">
                    ...
                    <p id="form-submission"
                        style="font-size: 3rem;font-weight: bolder;padding:5rem 5rem;background-color: white;color: #617a55">
                        FORM SUBMISSION
                    </p>
                    ...
                    <section class="form-container" style="background-color: white">
                        <div class="col-xl-6" style="position: relative">
                            <div id="formaddbirdfilter" class="filter">
                                <button type="button" data-bs-toggle="modal" data-bs-target="#addbirdmodal"
                                    ...
                                    <div class="modal-content" style="width: fit-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="bird-list">
                                                ...
                                                <div class="bird-item">
                                                    <input class="bird-input" type="radio" name="selected-bird"
                                                        value="none" id="bird-none" checked>
                                                    <label for="bird-none">
                                                        None
                                                    </label>
                                                </div>
                                                ...
                                                <%--<c:forEach items="" var="birdinfo">--%>
                                                    <div class="bird-item">
                                                        <img src="img/Ellipse 2.png" alt="Trainer Avatar"
                                                            class="bird-image">
                                                        <input class="bird-input" type="radio" name="selected-bird"
                                                            value="abc" id="bird-1">
                                                        <label for="bird-1">
                                                    ...
                                                    <%--< /c:forEach>--%>
                                                        <!--end of bird-->
                                                        <div>
                                                            Don't have a bird yet? Add one <a
                                                                href="Customer_AddBird.jsp">here</a>
                                                        </div>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            <span id="choosebirdinvalid" style="display: none; color: red">Please choose
                                                a valid bird.</span>
                                            <button type="button" class="btn btn-secondary"
                                                data-bs-dismiss="modal">Close</button>
                                            <button type="button" class="btn btn-primary" onclick="saveBird()">Save
                                                changes</button>
                                        </div>
                                    </div>
                                </div>
                     ...
                     width: 50%;">
                                Bird Details
                                <button id="changebirdbutton" type="button" data-bs-toggle="modal"
                                    data-bs-target="#addbirdmodal"
                                    style="background: transparent; border: 0; display: none; margin-left: 2rem">
                                    <span>
                            ...
                            <div class="forms-container">
                                <form action="FormCourseServlet" method="POST">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row mb-5">
                                                <div class="img-container d-flex justify-content-center">
                                                    <img id="birdimg" class="showImg" src="assets/images/avata.png"
                                                        alt="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mb-5">
                                                        ...
                                                        <input type="text" id="birdname" value="" placeholder="Name"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="mb-5">
                                                        ...
                                                        <input type="text" class="form-control" id="birdtype"
                                            ...
                                            <div class="col-lg-12">
                                                <div class="mb-5">
                                                    ...
                                                    <input name="preferred_date" type="date" class="form-control"
                                                        id="preferredday" value="" required />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <!--these get sent-->
                                    <input name="birdID" id="birdID" type="text" value="${bird.bird_id}" hidden />

                                    <input name="course_id" type="text" value="${detail.courseID}" hidden />
                                    <input name="amount" type="text" value="${detail.price}" hidden />
                                    <!--these get sent-->
